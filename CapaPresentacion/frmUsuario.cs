    ...
    public partial class frmUsuario : Form
    {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            if (objUsuario.IdUsuario == 0)
            {
                ...
                {
                    dgvData.Rows.Add(new object[] {"",IdUsuarioGenerado, txtDocumento.Text, txtNombreCompleto.Text, txtCorreo.Text ,txtClaveUsuario.Text,
            ...
            else
            {
                ...
                if (resultado)
                {
                    ...
                    row.Cells["Clave"].Value = txtClaveUsuario.Text;
        ...
        private void dgvData_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dgvData.Columns[e.ColumnIndex].Name == "btnSeleccionar")
            {
                ...
                if(indice >= 0)
                {
                    ...
                    txtClaveUsuario.Text = dgvData.Rows[indice].Cells["Clave"].Value.ToString();
                    txtClaveConfirmarUsuario.Text = dgvData.Rows[indice].Cells["Clave"].Value.ToString();
